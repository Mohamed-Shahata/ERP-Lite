...
export const ar: Messages = {
  ...
  authLayout: {
    secureHub: "مركز عمليات آمن",
    tagline: "المالية والمخزون والمبيعات والمشتريات في مساحة عمل واحدة.",
    headline: "أدر عملياتك اليومية بوضوح وتحكم.",
    roleGated: "صلاحيات حسب الدور",
    httpOnlyCookies: "كوكيز HttpOnly",
    auditReady: "جاهز للتدقيق",
    footer: "مصادقة مفروضة من الخادم مع حماية مسارات لوحة التحكم.",
  },
  login: {
    welcome: "مرحباً بعودتك",
    title: "تسجيل الدخول إلى ERP Lite",
    subtitle: "استخدم حساب شركتك للمتابعة.",
