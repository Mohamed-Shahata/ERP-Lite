      ...
      <section className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6">
        ...
        <div className="mt-5 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
          {modules.map((module) => (
            <div
              key={module}
              className="rounded-xl border border-slate-200 dark:border-slate-800 bg-blue-50/60 dark:bg-slate-800 px-4 py-3 text-sm font-medium text-slate-700 dark:text-slate-300"
            >
              {module}
            </div>
          ))}
