      ...
      <section className="overflow-hidden rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900">
        ...
        {canManage && (
          <form
            ...
            className="grid gap-4 border-b border-slate-200 dark:border-slate-800 p-5 md:grid-cols-2 lg:grid-cols-4"
          >
            <div>
              <label
                htmlFor="product-sku"
            ...
            <button
              className="h-10 rounded-md bg-slate-950 dark:bg-emerald-600 px-4 text-sm font-medium text-white hover:bg-slate-800 dark:hover:bg-emerald-700 disabled:cursor-not-allowed disabled:bg-slate-400 dark:disabled:bg-slate-700 lg:col-span-4"
              disabled={isSaving}
              type="submit"
            >
                    ...
                    <tr key={product.id} className="align-top">
                          ...
                          <div className="grid gap-2">
                            <div>
                              ...
                              <input
                                ...
                                className="h-9 w-full rounded-md border border-slate-300 dark:border-slate-700 px-3 text-sm focus:border-slate-500 dark:focus:border-slate-600 focus:outline-none focus:ring-1 focus:ring-slate-500 dark:focus:ring-slate-600"
                                onChange={(event) =>
                        ...
                        {isEditing ? (
                          <div>
                            ...
                            <input
                              ...
                              className="h-9 w-24 rounded-md border border-slate-300 dark:border-slate-700 px-3 text-sm focus:border-slate-500 dark:focus:border-slate-600 focus:outline-none focus:ring-1 focus:ring-slate-500 dark:focus:ring-slate-600"
                              min={0}
                              onChange={(event) =>
                                setProductEditForm((current) => ({
                                  ...current,
                      ...
                      <td className="px-5 py-4">
                        {isEditing ? (
                          ...
                          <select
                            className={`h-9 rounded-md border px-3 text-sm focus:border-slate-500 dark:focus:border-slate-600 focus:outline-none focus:ring-1 focus:ring-slate-500 dark:focus:ring-slate-600 ${
                              product.isActive
                                ? "border-emerald-200 dark:border-emerald-900 bg-emerald-50 dark:bg-emerald-950/40 font-medium text-emerald-700 dark:text-emerald-400"
                                : "border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 font-medium text-slate-500 dark:text-slate-400"
